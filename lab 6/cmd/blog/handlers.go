	...
	return []recentPostData{
		{
			...
			MainImg:   "/static/image/Post3Image.png",
			Author:    "William Wong",
			AuthorImg: "/static/image/Person2Image.png",
			PubDate:   "9/25/2015",
		},
		{
			...
			MainImg:   "/static/image/Post4Image.png",
			Author:    "Mat Vogels",
			AuthorImg: "/static/image/Person1Image.png",
			PubDate:   "9/25/2015",
		},
		{
			...
			MainImg:   "/static/image/Post5Image.png",
			Author:    "Mat Vogels",
			AuthorImg: "/static/image/Person1Image.png",
			PubDate:   "9/25/2015",
		},
		{
			...
			MainImg:   "/static/image/Post6Image.png",
			Author:    "William Wong",
			AuthorImg: "/static/image/Person2Image.png",
			PubDate:   "9/25/2015",
		},
		{
			...
			MainImg:   "/static/image/Post7Image.png",
			Author:    "Mat Vogels",
			AuthorImg: "/static/image/Person1Image.png",
			PubDate:   "9/25/2015",
		},
		{
			...
			MainImg:   "/static/image/Post8Image.png",
			Author:    "Mat Vogels",
			AuthorImg: "/static/image/Person1Image.png",
			PubDate:   "9/25/2015",
		},
...
func post(w http.ResponseWriter, r *http.Request) {
	...
	data := postData{
		Title:    "The Road Ahead",
		Subtitle: "The road ahead might be paved - it might not be.",
		MainImg:  "/static/image/Post1FonImage.png",
		Text:     postParagraphs(),
	}
